...
public class HavingFilterQuery implements org.apache.thrift.TBase<HavingFilterQuery, HavingFilterQuery._Fields>,
    java.io.Serializable, Cloneable, Comparable<HavingFilterQuery> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new HavingFilterQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new HavingFilterQueryTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.AGGREGATION_INFO,
        new org.apache.thrift.meta_data.FieldMetaData("aggregationInfo",
            org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
                org.apache.thrift.protocol.TType.STRUCT, "AggregationInfo")));
    ...
    tmpMap.put(_Fields.NESTED_FILTER_QUERY_IDS,
        new org.apache.thrift.meta_data.FieldMetaData("nestedFilterQueryIds",
  ...
  public HavingFilterQuery(int id, java.util.List<java.lang.String> value,
  ...
  public HavingFilterQuery(HavingFilterQuery other) {
    ...
    if (other.isSetNestedFilterQueryIds()) {
      java.util.List<java.lang.Integer> __this__nestedFilterQueryIds =
          new java.util.ArrayList<java.lang.Integer>(other.nestedFilterQueryIds);
  ...
  public void setNestedFilterQueryIds(
      @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> nestedFilterQueryIds) {
    this.nestedFilterQueryIds = nestedFilterQueryIds;
  }
  ...
  public int compareTo(HavingFilterQuery other) {
    ...
    lastComparison =
        java.lang.Boolean.valueOf(isSetNestedFilterQueryIds()).compareTo(other.isSetNestedFilterQueryIds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNestedFilterQueryIds()) {
  ...
  private static class HavingFilterQueryStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<HavingFilterQuery> {
