...
public class Function implements org.apache.thrift.TBase<Function, Function._Fields>, java.io.Serializable, Cloneable,
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new FunctionStandardSchemeFactory();
  ...
  public Function(java.lang.String operator) {
    this();
  ...
  public int compareTo(Function other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOperands()).compareTo(other.isSetOperands());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOperands()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.operands = new java.util.ArrayList<Expression>(_list44.size);
                @org.apache.thrift.annotation.Nullable
                Expression _elem45;
                for (int _i46 = 0; _i46 < _list44.size; ++_i46) {
                  _elem45 = new Expression();
                  _elem45.read(iprot);
                  struct.operands.add(_elem45);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.operands != null) {
        if (struct.isSetOperands()) {
          oprot.writeFieldBegin(OPERANDS_FIELD_DESC);
          {
            ...
            for (Expression _iter47 : struct.operands) {
              _iter47.write(oprot);
            }
            oprot.writeListEnd();
          }
      ...
      if (struct.isSetOperands()) {
        {
          ...
          for (Expression _iter48 : struct.operands) {
            _iter48.write(oprot);
          }
        }
      }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.operands = new java.util.ArrayList<Expression>(_list49.size);
          @org.apache.thrift.annotation.Nullable
          Expression _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51) {
            _elem50 = new Expression();
            _elem50.read(iprot);
            struct.operands.add(_elem50);
          }
        }
        struct.setOperandsIsSet(true);
      }
