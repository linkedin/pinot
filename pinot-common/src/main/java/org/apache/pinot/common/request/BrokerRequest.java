...
public class BrokerRequest implements org.apache.thrift.TBase<BrokerRequest, BrokerRequest._Fields>,
    java.io.Serializable, Cloneable, Comparable<BrokerRequest> {
  ...
  private static final org.apache.thrift.protocol.TField ORDER_BY_FIELD_DESC =
      new org.apache.thrift.protocol.TField("orderBy", org.apache.thrift.protocol.TType.LIST, (short) 18);
  private static final org.apache.thrift.protocol.TField LIMIT_FIELD_DESC =
      new org.apache.thrift.protocol.TField("limit", org.apache.thrift.protocol.TType.I32, (short) 19);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new BrokerRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new BrokerRequestTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.QUERY_SOURCE, new org.apache.thrift.meta_data.FieldMetaData("querySource",
    ...
    tmpMap.put(_Fields.DURATION,
        new org.apache.thrift.meta_data.FieldMetaData("duration", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.FILTER_QUERY, new org.apache.thrift.meta_data.FieldMetaData("filterQuery",
        org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FilterQuery.class)));
    tmpMap.put(_Fields.AGGREGATIONS_INFO,
        new org.apache.thrift.meta_data.FieldMetaData("aggregationsInfo",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
    ...
    tmpMap.put(_Fields.RESPONSE_FORMAT,
        new org.apache.thrift.meta_data.FieldMetaData("responseFormat",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    tmpMap.put(_Fields.QUERY_OPTIONS,
        new org.apache.thrift.meta_data.FieldMetaData("queryOptions", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING),
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.HAVING_FILTER_QUERY,
        new org.apache.thrift.meta_data.FieldMetaData("havingFilterQuery",
            org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.StructMetaData(
                org.apache.thrift.protocol.TType.STRUCT, HavingFilterQuery.class)));
    tmpMap.put(_Fields.HAVING_FILTER_SUB_QUERY_MAP,
        new org.apache.thrift.meta_data.FieldMetaData("havingFilterSubQueryMap",
            org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.StructMetaData(
                org.apache.thrift.protocol.TType.STRUCT, HavingFilterQueryMap.class)));
    ...
    tmpMap.put(_Fields.ORDER_BY,
        new org.apache.thrift.meta_data.FieldMetaData("orderBy", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                    SelectionSort.class))));
  ...
  public BrokerRequest(BrokerRequest other) {
    ...
    if (other.isSetAggregationsInfo()) {
      java.util.List<AggregationInfo> __this__aggregationsInfo =
          new java.util.ArrayList<AggregationInfo>(other.aggregationsInfo.size());
    ...
    if (other.isSetDebugOptions()) {
      java.util.Map<java.lang.String, java.lang.String> __this__debugOptions =
          new java.util.HashMap<java.lang.String, java.lang.String>(other.debugOptions);
      this.debugOptions = __this__debugOptions;
    }
    if (other.isSetQueryOptions()) {
      java.util.Map<java.lang.String, java.lang.String> __this__queryOptions =
          new java.util.HashMap<java.lang.String, java.lang.String>(other.queryOptions);
  ...
  public void setAggregationsInfo(
      @org.apache.thrift.annotation.Nullable java.util.List<AggregationInfo> aggregationsInfo) {
  ...
  public void setDebugOptions(
      @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> debugOptions) {
  ...
  public void setQueryOptions(
      @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> queryOptions) {
  ...
  public void setHavingFilterSubQueryMap(
      @org.apache.thrift.annotation.Nullable HavingFilterQueryMap havingFilterSubQueryMap) {
  ...
  public void setPinotQuery(
      @org.apache.thrift.annotation.Nullable org.apache.pinot.common.request.PinotQuery pinotQuery) {
  ...
  public int compareTo(BrokerRequest other) {
    ...
    lastComparison =
        java.lang.Boolean.valueOf(isSetHavingFilterSubQueryMap()).compareTo(other.isSetHavingFilterSubQueryMap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHavingFilterSubQueryMap()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                @org.apache.thrift.annotation.Nullable
                java.lang.String _key106;
                @org.apache.thrift.annotation.Nullable
                java.lang.String _val107;
        ...
        if (struct.isSetOrderBy()) {
          oprot.writeFieldBegin(ORDER_BY_FIELD_DESC);
          {
            oprot.writeListBegin(
                new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.orderBy.size()));
  ...
  private static class BrokerRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<BrokerRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BrokerRequest struct)
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list124 =
      ...
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TMap _map127 = new org.apache.thrift.protocol.TMap(
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TMap _map131 = new org.apache.thrift.protocol.TMap(
              org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
