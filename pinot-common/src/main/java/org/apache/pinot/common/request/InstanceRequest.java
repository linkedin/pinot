...
public class InstanceRequest implements org.apache.thrift.TBase<InstanceRequest, InstanceRequest._Fields>,
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new InstanceRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new InstanceRequestTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.SEARCH_SEGMENTS,
        new org.apache.thrift.meta_data.FieldMetaData("searchSegments",
  ...
  public InstanceRequest(InstanceRequest other) {
    ...
    if (other.isSetSearchSegments()) {
      java.util.List<java.lang.String> __this__searchSegments =
          new java.util.ArrayList<java.lang.String>(other.searchSegments);
  ...
  public void setSearchSegments(
      @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> searchSegments) {
  ...
  public int compareTo(InstanceRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSearchSegments()).compareTo(other.isSetSearchSegments());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSearchSegments()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBrokerId()).compareTo(other.isSetBrokerId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBrokerId()) {
