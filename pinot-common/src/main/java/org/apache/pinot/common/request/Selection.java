...
public class Selection implements org.apache.thrift.TBase<Selection, Selection._Fields>, java.io.Serializable,
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new SelectionStandardSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.SELECTION_COLUMNS,
        new org.apache.thrift.meta_data.FieldMetaData("selectionColumns",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.SELECTION_SORT_SEQUENCE,
        new org.apache.thrift.meta_data.FieldMetaData("selectionSortSequence",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
  ...
  public Selection(Selection other) {
    ...
    if (other.isSetSelectionColumns()) {
      java.util.List<java.lang.String> __this__selectionColumns =
          new java.util.ArrayList<java.lang.String>(other.selectionColumns);
      this.selectionColumns = __this__selectionColumns;
    }
    if (other.isSetSelectionSortSequence()) {
      java.util.List<SelectionSort> __this__selectionSortSequence =
          new java.util.ArrayList<SelectionSort>(other.selectionSortSequence.size());
  ...
  public void setSelectionColumns(
      @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> selectionColumns) {
  ...
  public void setSelectionSortSequence(
      @org.apache.thrift.annotation.Nullable java.util.List<SelectionSort> selectionSortSequence) {
  ...
  public int compareTo(Selection other) {
    ...
    lastComparison =
        java.lang.Boolean.valueOf(isSetSelectionSortSequence()).compareTo(other.isSetSelectionSortSequence());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSelectionSortSequence()) {
