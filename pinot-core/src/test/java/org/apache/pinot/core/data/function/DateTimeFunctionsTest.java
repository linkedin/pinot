...
public class DateTimeFunctionsTest {
  ...
  public Object[][] dateTimeFunctionsDataProvider() {
    ...
    inputs
        .add(new Object[] { "toEpochMinutesBucket(timestamp, 15)", Lists.newArrayList("timestamp"), row2_2, 1754094L });
    ...
    inputs.add(new Object[] { "fromEpochDaysBucket(sevenDaysSinceEpoch, 7)", Lists
        .newArrayList("sevenDaysSinceEpoch"), row5_1, 1209600000000L });

    // fromEpochHours
    GenericRow row6_0 = new GenericRow();
    row6_0.putValue("hoursSinceEpoch", 336000);
    inputs.add(new Object[] { "fromEpochHours(hoursSinceEpoch)", Lists
        .newArrayList("hoursSinceEpoch"), row6_0, 1209600000000L });

    // fromEpochHours w/ bucketing
    GenericRow row6_1 = new GenericRow();
    row6_1.putValue("twoHoursSinceEpoch", 168000);
    inputs.add(new Object[] { "fromEpochHoursBucket(twoHoursSinceEpoch, 2)", Lists
        .newArrayList("twoHoursSinceEpoch"), row6_1, 1209600000000L });

    // fromEpochMinutes
    GenericRow row7_0 = new GenericRow();
    row7_0.putValue("minutesSinceEpoch", 20160000);
    inputs.add(new Object[] { "fromEpochMinutes(minutesSinceEpoch)", Lists
        .newArrayList("minutesSinceEpoch"), row7_0, 1209600000000L });

    // fromEpochMinutes w/ bucketing
    GenericRow row7_1 = new GenericRow();
    row7_1.putValue("fifteenMinutesSinceEpoch", 1344000);
    inputs.add(new Object[] { "fromEpochMinutesBucket(fifteenMinutesSinceEpoch, 15)", Lists
        .newArrayList("fifteenMinutesSinceEpoch"), row7_1, 1209600000000L });

    // fromEpochSeconds
    GenericRow row8_0 = new GenericRow();
    row8_0.putValue("secondsSinceEpoch", 1209600000L);
    inputs.add(new Object[] { "fromEpochSeconds(secondsSinceEpoch)", Lists
        .newArrayList("secondsSinceEpoch"), row8_0, 1209600000000L });

    // fromEpochSeconds w/ bucketing
    GenericRow row8_1 = new GenericRow();
    row8_1.putValue("tenSecondsSinceEpoch", 120960000L);
    inputs.add(new Object[] { "fromEpochSecondsBucket(tenSecondsSinceEpoch, 10)", Lists
        .newArrayList("tenSecondsSinceEpoch"), row8_1, 1209600000000L });

    // nested
    GenericRow row9_0 = new GenericRow();
    row9_0.putValue("hoursSinceEpoch", 336000);
    inputs.add(new Object[] { "toEpochDays(fromEpochHours(hoursSinceEpoch))", Lists
        .newArrayList("hoursSinceEpoch"), row9_0, 14000L });

    GenericRow row9_1 = new GenericRow();
    row9_1.putValue("fifteenSecondsSinceEpoch", 80640000L);
    inputs.add(new Object[] { "toEpochMinutesBucket(fromEpochSecondsBucket(fifteenSecondsSinceEpoch, 15), 10)", Lists
        .newArrayList("fifteenSecondsSinceEpoch"), row9_1, 2016000L });

    // toDateTime simple
    GenericRow row10_0 = new GenericRow();
    row10_0.putValue("dateTime", 98697600000L);
    inputs
        .add(new Object[] { "toDateTime(dateTime, 'yyyyMMdd')", Lists.newArrayList("dateTime"), row10_0, "19730216" });

    // toDateTime complex
    GenericRow row10_1 = new GenericRow();
    row10_1.putValue("dateTime", 1234567890000L);
    inputs.add(new Object[] { "toDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", Lists
        .newArrayList("dateTime"), row10_1, "02/2009/13 23:31:30" });

    // toDateTime with timezone
    GenericRow row10_2 = new GenericRow();
    row10_2.putValue("dateTime", 7897897890000L);
    inputs.add(new Object[] { "toDateTime(dateTime, 'EEE MMM dd HH:mm:ss ZZZ yyyy')", Lists
        .newArrayList("dateTime"), row10_2, "Mon Apr 10 20:31:30 UTC 2220" });

    // fromDateTime simple
    GenericRow row11_0 = new GenericRow();
    row11_0.putValue("dateTime", "19730216");
    inputs.add(
        new Object[] { "fromDateTime(dateTime, 'yyyyMMdd')", Lists.newArrayList("dateTime"), row11_0, 98668800000L });

    // fromDateTime complex
    GenericRow row11_1 = new GenericRow();
    row11_1.putValue("dateTime", "02/2009/13 15:31:30");
    inputs.add(new Object[] { "fromDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", Lists
        .newArrayList("dateTime"), row11_1, 1234539090000L });
    ...
    inputs.add(new Object[] { "fromDateTime(dateTime, \"EEE MMM dd HH:mm:ss ZZZ yyyy\")", Lists
        .newArrayList("dateTime"), row11_2, 1251142606000L });
