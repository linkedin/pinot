...
public class GroovyTransformFunctionTest extends BaseTransformFunctionTest {
  ...
  public Object[][] testIllegalArguments() {
    ...
    inputs.add(new Object[] { String
        .format("groovy('{\"returnType\":\"INT\", \"isSingleValue\":null}', 'arg0 + 10', %s)", INT_SV_COLUMN) });
    // return type must be valid DataType enum
    inputs.add(new Object[] { String
        .format("groovy('{\"returnType\":\"foo\", \"isSingleValue\":true}', 'arg0 + 10', %s)", INT_SV_COLUMN) });
