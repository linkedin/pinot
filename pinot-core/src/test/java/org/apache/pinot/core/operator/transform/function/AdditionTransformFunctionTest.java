...
public class AdditionTransformFunctionTest extends BaseTransformFunctionTest {
  ...
  public void testAdditionTransformFunction() {
    ExpressionContext expression = RequestContextUtils.getExpression(String.format("add(%s,%s,%s,%s,%s)", INT_SV_COLUMN,
        LONG_SV_COLUMN, FLOAT_SV_COLUMN, DOUBLE_SV_COLUMN, STRING_SV_COLUMN));
    ...
    expression = RequestContextUtils.getExpression(String.format("add(add(12,%s),%s,add(add(%s,%s),0.34,%s),%s)",
  ...
  public Object[][] testIllegalArguments() {
    return new Object[][] { new Object[] { String.format("add(%s)", INT_SV_COLUMN) }, new Object[] { String
        .format("add(%s, %s)", LONG_SV_COLUMN, INT_MV_COLUMN) } };
  }
}
