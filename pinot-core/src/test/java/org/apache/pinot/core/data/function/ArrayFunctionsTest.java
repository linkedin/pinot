...
public class ArrayFunctionsTest {
  ...
  public Object[][] arrayFunctionsDataProvider() {
    ...
    inputs
        .add(new Object[] { "array_index_of_int(integerArray, 2)", Collections.singletonList("integerArray"), row, 1 });
    ...
    inputs.add(
        new Object[] { "array_index_of_string(stringArray, '2')", Collections.singletonList("stringArray"), row, 1 });

    inputs.add(new Object[] { "array_contains_int(intArray, 2)", Collections.singletonList("intArray"), row, true });
    inputs.add(
        new Object[] { "array_contains_int(integerArray, 2)", Collections.singletonList("integerArray"), row, true });
    inputs.add(
        new Object[] { "array_contains_int(stringArray, 2)", Collections.singletonList("stringArray"), row, true });

    inputs
        .add(new Object[] { "array_contains_string(intArray, '2')", Collections.singletonList("intArray"), row, true });
    inputs.add(new Object[] { "array_contains_string(integerArray, '2')", Collections
        .singletonList("integerArray"), row, true });
    inputs.add(new Object[] { "array_contains_string(stringArray, '2')", Collections
        .singletonList("stringArray"), row, true });

    inputs.add(new Object[] { "array_slice_int(intArray, 1, 2)", Collections
        .singletonList("intArray"), row, new int[] { 2 } });
