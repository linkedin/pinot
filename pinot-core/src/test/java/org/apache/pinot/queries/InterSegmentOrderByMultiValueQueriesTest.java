...
public class InterSegmentOrderByMultiValueQueriesTest extends BaseMultiValueQueriesTest {
  ...
  public Object[][] orderByDataProvider() {
    ...
    results = Lists.newArrayList(new Object[] { "NCoFku", 489626381288.0 },
        new Object[] { "mhoVvrJm", 5806796153884.0 }, new Object[] { "JXRmGakTYafZFPm", 18408231081808.0 },
        new Object[] { "PbQd", 36532997335388.0 }, new Object[] { "OKyOqU", 51067166589176.0 });
    dataSchema = new DataSchema(new String[] { "column5", "summv(column7)" },
        new DataSchema.ColumnDataType[] { DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE });
    numEntriesScannedPostFilter = 800000;
    data.add(new Object[] { query, results, numEntriesScannedPostFilter, dataSchema });
    ...
    results = Lists.newArrayList(new Object[] { "NCoFku" }, new Object[] { "mhoVvrJm" },
        new Object[] { "JXRmGakTYafZFPm" }, new Object[] { "PbQd" }, new Object[] { "OKyOqU" });
    dataSchema = new DataSchema(new String[] { "column5" },
    ...
    results = Lists.newArrayList(new Object[] { "AKXcXcIqsqOJFsdwxZ", 2147483446.0 },
        ...
        new Object[] { "NCoFku", 2147483436.0 }, new Object[] { "OKyOqU", 2147483443.0 },
        new Object[] { "PbQd", 2147483443.0 }, new Object[] { "kCMyNVGCASKYDdQbftOPaqVMWc", 2147483446.0 },
        new Object[] { "mhoVvrJm", 2147483438.0 }, new Object[] { "yQkJTLOQoOqqhkAClgC", 2147483446.0 });
