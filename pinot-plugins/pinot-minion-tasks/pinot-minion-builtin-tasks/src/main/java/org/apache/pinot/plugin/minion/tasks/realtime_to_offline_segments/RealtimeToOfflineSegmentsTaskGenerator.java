  ...
  public List<PinotTaskConfig> generateTasks(List<TableConfig> tableConfigs) {
    ...
    for (TableConfig tableConfig : tableConfigs) {
      ...
      String partitionBucketTimePeriod =
          taskConfigs.get(RealtimeToOfflineSegmentsTask.PARTITION_BUCKET_TIME_PERIOD_KEY);
      if (partitionBucketTimePeriod != null) {
        configs.put(RealtimeToOfflineSegmentsTask.PARTITION_BUCKET_TIME_PERIOD_KEY, partitionBucketTimePeriod);
      }
